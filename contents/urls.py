...
contents_list,signup,regionalpapers_list,nationalpapers_list,Articles,android,login)
...
urlpatterns = [
    ...
    url(r'^nationalpapers_list/',nationalpapers_list,name='nationalpapers_list'),
